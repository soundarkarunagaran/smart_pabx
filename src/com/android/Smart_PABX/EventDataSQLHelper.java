...
public class EventDataSQLHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		String sql = "create table " + TABLE + "( " + BaseColumns._ID
				+ " integer primary key , " + TIME + " integer, "
				+ TITLE + " text not null);";
		Log.d("EventsData", "onCreate: " + sql);
		
		sqlCreateTable = "CREATE TABLE"+" "+TABLE + "("+" "+BaseColumns._ID+" "+"INTEGER PRIMARY KEY,"+" "+KEY+" "+"INTEGER NOT NULL,"+" "+virtExtension+" "+"VARCHAR(5) NOT NULL,"+" "+virtNumber+" "+"VARCHAR(15) NOT NULL,"+" "+realNumber+" "+"VARCHAR(15) NOT NULL,"+" "+userName+" "+"VARCHAR(255),"+" "+userDesig+" "+"VARCHAR(255),"+" "+deptID+" "+"INTEGER,"+" "+allowAdminCompanyVm+" "+"INTEGER NOT NULL,"+" "+allowAdminFeedback+" "+"INTEGER NOT NULL,"+" "+allowVM+" "+" "+"INTEGER NOT NULL,"+" "+allowOutdial+" "+"INTEGER NOT NULL,"+" "+prefBusyAction+" "+"INTEGER,"+" "+prefBusyNextExtension+" "+"VARCHAR(5),"+" "+prefDndAction+" "+"INTEGER,"+" "+prefDndNextExtension+" "+"VARCHAR(5),"+" "+prefRejAction+" "+"INTEGER,"+" "+prefRejNextExtension+" "+"VARCHAR(5),"+" "+status+" "+"INTEGER NOT NULL,"+" "+dt+" "+"TIMESTAMP NOT NULL,"+" "+login+" "+"VARCHAR(20) NOT NULL,"+" "+allowObdMsgRec+" "+"INTEGER NOT NULL,"+" "+pwd+" "+"VARCHAR(50) NOT NULL,"+" "+isOwner+" "+"INTEGER NOT NULL,"+" "+role+" "+"INTEGER NOT NULL,"+" "+sessionID+" "+"LONGTEXT,"+" "+dndSchedType+" "+"INTEGER,"+" "+dndSchedStartMin+" "+"INTEGER,"+" "+dndSchedEndMin+" "+"INTEGER,"+" "+dndSchedSun+" "+"INTEGER,"+" "+dndSchedMon+" "+"INTEGER,"+" "+dndSchedTue+" "+"INTEGER,"+" "+dndSchedWed+" "+"INTEGER,"+" "+dndSchedThu+" "+"INTEGER,"+" "+dndSchedFri+" "+"INTEGER,"+" "+dndSchedSat+" "+"INTEGER,"+" "+chnlID+" "+"VARCHAR(50),"+" "+asterikHost+" "+"VARCHAR(25),"+" "+dialinReqStartTime+" "+"TIMESTAMP,"+" "+allowIntercom+" "+"INTEGER DEFAULT 0,"+" "+allowFreeIntercom+" "+"INTEGER DEFAULT 0);";
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		String sql = null;
		final String ALTER_TBL = "ALTER TABLE " + TABLE +" ADD COLUMN oldPwd varchar(50) default yrwiutwcbeiurtwi;";
		if (oldVersion == 1) 
